...
export default function Register() {
  ...
  const inputClass = (hasError) =>
    `w-full mb-2 px-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 bg-white dark:bg-slate-800 text-gray-900 dark:text-white placeholder:text-slate-400 transition-colors ${
